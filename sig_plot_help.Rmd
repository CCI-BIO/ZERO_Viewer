...
The specified sample to show in the gene signature TPM plot can be selected using the 'Select sample ID:' drop down menu. 

The resulting plot can be **downloaded** as a png file using the download button at the bottom left corner. 
